...
## 4. Hallazgos Clave
*   Identificación de los 3 principales motivos de queja.
*   Evolución del sentimiento promedio por categorías.
*   Relación directa entre longitud de comentario y polaridad.

## 5. Visualizaciones (Demo)
*   Dashboard interactivo con Plotly.
*   Nube de palabras de los promotores y detractores.
*   Histogramas de distribución de usuarios.

## 6. Conclusión y Futuro
*   El pipeline es replicable para cualquier otra marca.
*   Posibilidad de integrar modelos de Deep Learning para mayor precisión.
*   Impacto directo en la mejora del servicio al cliente.
